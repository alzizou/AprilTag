...
Results_File_AprilTag_RelPos = open(r"/root/ali_ws/AprilTag/ali_ws/logs/Results_File_AprilTag_RelPos.txt","w+")
Results_File_AprilTag_Euler1 = open(r"/root/ali_ws/AprilTag/ali_ws/logs/Results_File_AprilTag_Euler1.txt","w+")
Results_File_AprilTag_Euler2 = open(r"/root/ali_ws/AprilTag/ali_ws/logs/Results_File_AprilTag_Euler2.txt","w+")
Results_File_AprilTag_Quat = open(r"/root/ali_ws/AprilTag/ali_ws/logs/Results_File_AprilTag_Quat.txt","w+")
Results_File_AprilTag_UnitVector = open(r"/root/ali_ws/AprilTag/ali_ws/logs/Results_File_AprilTag_UnitVector.txt","w+")
